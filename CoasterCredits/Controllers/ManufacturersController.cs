...
namespace CoasterCredits.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ManufacturersController(CoasterCreditsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ManufacturerID,ManufacturerName,ManufacturerLocation")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ManufacturerID,ManufacturerName,ManufacturerLocation")] Manufacturer manufacturer)
        {
